...
<div class="login-page">
    <div class="login-card">
        ...
        <div class="auth-form <?= $activeTab !== 'login' ? 'hidden' : '' ?>" id="loginForm">
            <h2><?= $roleParam === 'organizer' ? 'Log in to your organizer account' : 'Welcome back' ?></h2>
            <p class="lead"><?= $roleParam === 'organizer' ? 'Sign in to manage your tournaments' : 'Sign in to your TournamentHQ account' ?></p>
